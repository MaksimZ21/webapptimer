...
const TimerApp = () => {
  ...
  const sound10Seconds = useRef(new Howl({ src: [`${process.env.PUBLIC_URL}/images/lastseconds.mp3`] })).current;
  const sound5Minutes = useRef(new Howl({ src: [`${process.env.PUBLIC_URL}'/images/secondshotclock.mp3`] })).current;
  const soundSub = useRef(new Howl({ src: [`${process.env.PUBLIC_URL}/images/timersoundeffect.mp3`] })).current;
